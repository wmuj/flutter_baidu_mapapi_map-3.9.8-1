...
import com.baidu.bmfmap.cluster.clustering.algo.Algorithm;
import com.baidu.bmfmap.cluster.clustering.algo.NonHierarchicalDistanceBasedAlgorithm;
...
public class ClusterManager<T extends ClusterItem> implements
    ...
    public void setMaxDistanceZoom(int maxDistanceZoom) {
        NonHierarchicalDistanceBasedAlgorithm.maxDistanceAtZoom = maxDistanceZoom;
    }
