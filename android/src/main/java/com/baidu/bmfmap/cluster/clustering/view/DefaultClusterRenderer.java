...
package com.baidu.bmfmap.cluster.clustering.view;

import static com.baidu.bmfmap.cluster.clustering.algo.NonHierarchicalDistanceBasedAlgorithm.maxDistanceAtZoom;
...
public class DefaultClusterRenderer<T extends ClusterItem> implements
        com.baidu.bmfmap.cluster.clustering.view.ClusterRenderer<T> {
    ...
    private com.baidu.bmfmap.cluster.ui.SquareTextView makeSquareTextView(Context context) {
        com.baidu.bmfmap.cluster.ui.SquareTextView squareTextView =
                new com.baidu.bmfmap.cluster.ui.SquareTextView(context);
